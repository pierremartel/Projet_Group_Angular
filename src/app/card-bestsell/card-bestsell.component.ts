...
@Component({
  selector: 'app-card-bestsell',
  templateUrl: './card-bestsell.component.html',
  styleUrls: ['./card-bestsell.component.css']
})
export class CardBestsellComponent implements OnInit {
